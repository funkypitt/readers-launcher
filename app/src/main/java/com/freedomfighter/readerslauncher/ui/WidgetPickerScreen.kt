    ...
    Page {
        Column(Modifier.fillMaxSize()) {
            ...
            LazyColumn(Modifier.weight(1f), contentPadding = PaddingValues(bottom = 24.dp)) {
                ...
                item {
                    TextRow(stringResource(R.string.widget_listen), secondary = stringResource(R.string.widget_listen_desc)) {
                        app.store.addTile(com.freedomfighter.readerslauncher.data.ListenTile()); nav.pop()
                    }
                }
                item {
                    TextRow(stringResource(R.string.widget_food), secondary = stringResource(R.string.widget_food_desc)) {
                        app.store.addTile(com.freedomfighter.readerslauncher.data.FoodTile()); nav.pop()
                    }
                }
                item {
